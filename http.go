...
//AuthorizedRequestXML method(GET, POST, PUT, DELETE), token([example] Bearer FB02HH1WO1-BEUNCEPYKEA) return struct
...
//AuthorizedRequestMultipart method(GET, POST, PUT, DELETE), token([example] Bearer FB02HH1WO1-BEUNCEPYKEA) return struct
...
//AuthorizedMultipart method(GET, POST, PUT, DELETE), token([example] Bearer FB02HH1WO1-BEUNCEPYKEA) return struct
